...
let AuthenticationService = class AuthenticationService {
    ...
    login(credentials) {
        return this.http.post(`http://localhost:3000/user/singin`, credentials).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)((data) => data.token), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(token => {
